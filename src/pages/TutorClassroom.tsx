...
export default function TutorClassroom() {
  ...
  const beginCall = async () => {
    ...
    const isEmptyLesson = Boolean((data as any).empty) || (Boolean((data as any).complete) && !greeting.trim());
    if (isEmptyLesson) {
      // Chapter has no script yet — show a placeholder and do NOT start voice.
      setCaption({ text: 'Lesson content coming soon.', who: 'tutor' });
      return;
    }
