...
(Student Response — STOP here. Do NOT continue to "Very good!" or to TODAY'S QUICK REVISION until the student has actually spoken an answer. beatType MUST be "question" and awaitingStudentResponse MUST be true.)

Very good, {studentFirstName}!



TODAY'S QUICK REVISION

(REVISION RULES — follow strictly for every question below:
1. Speak ONLY the question sentence itself (e.g. "Question 1: How are you?"). Do NOT add "Ab aap jawab dijiye", "Aap boliye", "Answer kariye", "Reply kariye", "Tell me", or any similar prompt-to-answer phrase.
2. After speaking the question, STOP. beatType MUST be "question" and awaitingStudentResponse MUST be true. Wait silently for the student's spoken answer.
3. Once the student answers, give ONE short check — either praise ("Very good, {studentFirstName}!") if correct, or a brief correction with the expected answer if wrong. Do NOT re-ask the same question. Do NOT repeat "Ab aap jawab dijiye".
4. Then move directly to the next question. Never loop on the same question.
5. The "(Expected answer from student: ...)" lines are stage directions for YOU — never read them aloud.)

Question 1: How are you?

(Student Response — STOP. Wait for the student. Do NOT say "Ab aap jawab dijiye". After they answer, give one short check and go to Question 2.)

(Expected answer from student: I am fine. Thank you. How about you?)

Question 2: What do you do?

(Student Response — STOP. Wait for the student. Do NOT say "Ab aap jawab dijiye". After they answer, give one short check and go to Question 3.)

(Expected answer from student: I am a student of Class ___.)

Question 3: Where do you live?

(Student Response — STOP. Wait for the student. Do NOT say "Ab aap jawab dijiye". After they answer, give one short check and go to Question 4.)

(Expected answer from student: I live in __________.)

Question 4: Nice meeting you.

(Student Response — STOP. Wait for the student. Do NOT say "Ab aap jawab dijiye". After they answer, give one short check and move to CONGRATULATIONS.)
